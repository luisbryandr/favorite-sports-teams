...
function App() {
  return (
    <div className="App">
     <Header />
     <Team />
     {/* I could use map to render a Team component for each team in an array above,first hardcoded based on my favorite teams, later still my favorite teams but based on my list in my database.
